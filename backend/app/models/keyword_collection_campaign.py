...
class KeywordCollectionCampaign(Base):
    ...
    bound_worker_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    bound_browser_name: Mapped[str | None] = mapped_column(String(80), nullable=True)
    bound_browser_version: Mapped[str | None] = mapped_column(String(40), nullable=True)
    bound_extension_version: Mapped[str | None] = mapped_column(String(40), nullable=True)
