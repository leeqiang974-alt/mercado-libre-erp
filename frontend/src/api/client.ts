...
export type KeywordCampaign = {
  ...
  keywords: Array<{ keyword: string; discovered: number; processed: number; completed: number; running: number; pending: number; failed: number; needs_manual_action: number; skipped: number; status: string }>;
};
