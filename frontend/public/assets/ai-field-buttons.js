(() => {
  ...
  // The React rail already renders the actual selected item and paginates it
  // into view.  Do not inject a second “current editing” card at the top: it
  // becomes stale after deletion and makes the same product appear twice.
